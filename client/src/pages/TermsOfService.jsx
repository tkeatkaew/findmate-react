      ...
      <Container maxWidth="lg" sx={{ my: 4 }}>
        ...
        >
          ...
          <Typography
            ...
            sx={{ fontWeight: "bold", mt: 2 }}
          >
            5.1 การรายงานผู้ใช้บริการ
          </Typography>
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              5.1.1
              ผู้ใช้บริการสามารถรายงานผู้ใช้บริการรายอื่นที่ละเมิดข้อตกลงนี้หรือมีพฤติกรรมไม่เหมาะสมได้ผ่านระบบรายงานที่ให้บริการบนแพลตฟอร์ม
            </Typography>
            <Typography paragraph>
              5.1.2 เหตุผลในการรายงานรวมถึงแต่ไม่จำกัดเพียง: การคุกคามทางเพศ
              การฉ้อโกง การหลอกลวง การสร้างโปรไฟล์ปลอม
              หรือการเผยแพร่เนื้อหาที่ไม่เหมาะสม
            </Typography>
            <Typography paragraph>
              5.1.3 การรายงานต้องมีคำอธิบายที่ชัดเจนและข้อมูลประกอบที่เกี่ยวข้อง
              บริษัทขอสงวนสิทธิ์ในการปฏิเสธหรือไม่ดำเนินการตามรายงานที่ไม่มีมูลหรือไม่มีข้อมูลเพียงพอ
            </Typography>
          </Box>
          <Typography
            variant="h6"
            ...
            sx={{ fontWeight: "bold", mt: 2 }}
          >
            5.2 การรายงานปัญหาระบบ
          </Typography>
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              5.2.1
              ผู้ใช้บริการสามารถรายงานปัญหาทางเทคนิคหรือข้อบกพร่องของแพลตฟอร์มได้ผ่านระบบรายงานที่ให้บริการ
            </Typography>
            <Typography paragraph>
              5.2.2 ประเภทของปัญหาที่สามารถรายงานรวมถึงแต่ไม่จำกัดเพียง:
              ข้อผิดพลาดของระบบ ปัญหาการแสดงผล ปัญหาด้านประสิทธิภาพ
              และฟีเจอร์ที่ไม่ทำงาน
            </Typography>
            <Typography paragraph>
              5.2.3 ผู้ใช้บริการสามารถแนบภาพหน้าจอหรือหลักฐานอื่นๆ
              เพื่อแสดงปัญหาที่พบได้
            </Typography>
          </Box>
          ...
          <Typography
            ...
            sx={{ fontWeight: "bold", mt: 2 }}
          >
            5.3 การส่งข้อเสนอแนะ
          </Typography>
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              5.3.1
              ผู้ใช้บริการสามารถส่งข้อเสนอแนะหรือความคิดเห็นเกี่ยวกับการปรับปรุงแพลตฟอร์มได้ผ่านระบบที่ให้บริการ
            </Typography>
            <Typography paragraph>
              5.3.2 บริษัทจะพิจารณาข้อเสนอแนะทั้งหมดที่ได้รับ
              แต่ไม่มีภาระผูกพันในการนำข้อเสนอแนะดังกล่าวไปปฏิบัติหรือตอบกลับ
            </Typography>
          </Box>
          <Typography
            variant="h6"
            ...
            sx={{ fontWeight: "bold", mt: 2 }}
          >
            5.4 การระงับและยกเลิกบัญชี
          </Typography>
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              5.4.1
              บริษัทขอสงวนสิทธิ์ในการระงับหรือยกเลิกบัญชีผู้ใช้ชั่วคราวหรือถาวร
              ในกรณีที่บริษัทเห็นว่าผู้ใช้บริการละเมิดข้อตกลงนี้หรือกระทำการที่ไม่เหมาะสม
              โดยอาจแจ้งหรือไม่แจ้งให้ทราบล่วงหน้า
            </Typography>
            <Typography paragraph>
              5.4.2 เหตุผลในการระงับหรือยกเลิกบัญชีรวมถึงแต่ไม่จำกัดเพียง:
            </Typography>
            <Box sx={{ ml: 4 }}>
              <Typography paragraph>
                (ก) การละเมิดข้อตกลงนี้หรือนโยบายอื่นๆ ของบริษัท
                <br />
                (ข) การให้ข้อมูลเท็จหรือทำให้เข้าใจผิด ผู้ใช้บริการ
                หรือบุคคลอื่น
                <br />
                (ค) การมีพฤติกรรมที่เป็นการคุกคาม ล่วงละเมิด
                หรือทำให้ผู้อื่นไม่สบายใจ
                <br />
                (ง)
                การใช้แพลตฟอร์มในทางที่ผิดหรือเพื่อวัตถุประสงค์อื่นนอกเหนือจากที่กำหนดไว้
                <br />
                (จ) การกระทำผิดกฎหมายหรือส่งเสริมกิจกรรมที่ผิดกฎหมาย
                <br />
                (ฉ)
                การรายงานจากผู้ใช้บริการรายอื่นที่มีมูลเหตุอันควรเชื่อได้ว่ามีการกระทำผิด
              </Typography>
            </Box>
            <Typography paragraph>
              5.4.3 ในกรณีที่บัญชีถูกระงับ
              ผู้ใช้บริการจะไม่สามารถเข้าถึงแพลตฟอร์มได้จนกว่าจะได้รับการยกเลิกการระงับ
              เว้นแต่มีการติดต่อกับบริษัทและแก้ไขประเด็นที่เป็นสาเหตุของการระงับ
            </Typography>
            <Typography paragraph>
              5.4.4 ในกรณีที่บัญชีถูกยกเลิกถาวร
              ผู้ใช้บริการจะสูญเสียสิทธิ์ในการเข้าถึงแพลตฟอร์มและข้อมูลทั้งหมดที่เกี่ยวข้องกับบัญชีนั้น
              โดยไม่สามารถเรียกคืนได้
            </Typography>
          </Box>
          ...
          <Typography
            ...
            sx={{ fontWeight: "bold", mt: 2 }}
          >
            6.1 การลบบัญชีโดยผู้ใช้บริการ
          </Typography>
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              6.1.1
              ผู้ใช้บริการสามารถลบบัญชีของตนได้ตลอดเวลาผ่านการตั้งค่าบัญชีบนแพลตฟอร์ม
            </Typography>
            <Typography paragraph>
              6.1.2
              การลบบัญชีจะต้องยืนยันด้วยรหัสผ่านของผู้ใช้บริการเพื่อป้องกันการลบโดยไม่ได้รับอนุญาต
            </Typography>
            <Typography paragraph>
              6.1.3 การลบบัญชีเป็นการดำเนินการที่ไม่สามารถเพิกถอนได้
              และอาจส่งผลให้สูญเสียข้อมูลทั้งหมดที่เกี่ยวข้องกับบัญชีนั้นอย่างถาวร
            </Typography>
          </Box>
          <Typography
            variant="h6"
          ...
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>6.2.1 เมื่อบัญชีถูกลบ:</Typography>
            <Box sx={{ ml: 4 }}>
              <Typography paragraph>
                (ก) ข้อมูลส่วนบุคคล ลักษณะนิสัย
                และรูปภาพโปรไฟล์ของผู้ใช้บริการจะถูกลบออกจากระบบ
                <br />
                (ข)
                การถูกใจและการจับคู่ทั้งหมดที่เกี่ยวข้องกับผู้ใช้บริการจะถูกลบ
                <br />
                (ค) ผู้ใช้บริการจะไม่สามารถเข้าถึงบัญชีหรือข้อมูลใดๆ
                ที่เกี่ยวข้องกับบัญชีได้อีก
              </Typography>
            </Box>
            <Typography paragraph>
              6.2.2 บริษัทอาจเก็บรักษาข้อมูลบางอย่างไว้ตามที่กฎหมายกำหนด
              หรือเพื่อวัตถุประสงค์ทางธุรกิจที่ชอบด้วยกฎหมาย เช่น
              การป้องกันการฉ้อโกง การแก้ไขข้อพิพาท
              หรือการบังคับใช้ข้อตกลงของบริษัท
            </Typography>
          </Box>
          ...
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              7.1.1 แพลตฟอร์ม รวมถึงแต่ไม่จำกัดเพียงซอฟต์แวร์ กราฟิก
              ส่วนติดต่อผู้ใช้ เนื้อหา ข้อความ รูปแบบ และอัลกอริทึม
              เป็นทรัพย์สินของบริษัทหรือผู้อนุญาตให้ใช้สิทธิของบริษัท
              และได้รับความคุ้มครองตามกฎหมายทรัพย์สินทางปัญญา
            </Typography>
            <Typography paragraph>
              7.1.2 ชื่อ Find Mate โลโก้ เครื่องหมายการค้า
              และเครื่องหมายบริการทั้งหมดที่ปรากฏบนแพลตฟอร์มเป็นทรัพย์สินของบริษัทหรือผู้อนุญาตให้ใช้สิทธิของบริษัท
            </Typography>
            <Typography paragraph>
              7.1.3 ห้ามมิให้ผู้ใช้บริการทำซ้ำ ดัดแปลง เผยแพร่ แจกจ่าย ขาย
              ให้เช่า โอน ใช้วิศวกรรมย้อนกลับ
              หรือใช้ประโยชน์จากแพลตฟอร์มหรือส่วนใดส่วนหนึ่งของแพลตฟอร์มโดยไม่ได้รับอนุญาตเป็นลายลักษณ์อักษรจากบริษัท
            </Typography>
          </Box>
          <Typography
            variant="h6"
          ...
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              7.2.1
              ผู้ใช้บริการยังคงเป็นเจ้าของสิทธิในเนื้อหาผู้ใช้ที่อัปโหลดหรือโพสต์บนแพลตฟอร์ม
            </Typography>
            <Typography paragraph>
              7.2.2 โดยการอัปโหลดหรือโพสต์เนื้อหาผู้ใช้บนแพลตฟอร์ม
              ผู้ใช้บริการให้สิทธิ์แก่บริษัทแบบไม่จำกัดแต่เพียงผู้เดียว ทั่วโลก
              ปลอดค่าลิขสิทธิ์ สามารถให้สิทธิ์ช่วงได้ และสามารถโอนได้ ในการใช้
              ทำซ้ำ ดัดแปลง เผยแพร่ แสดง แจกจ่าย
              และสร้างงานดัดแปลงจากเนื้อหาผู้ใช้ เพื่อวัตถุประสงค์ในการให้บริการ
              ปรับปรุงแพลตฟอร์ม และวัตถุประสงค์ทางธุรกิจอื่นๆ ของบริษัท
            </Typography>
            <Typography paragraph>
              7.2.3
              ผู้ใช้บริการรับรองและรับประกันว่าเนื้อหาผู้ใช้ที่อัปโหลดหรือโพสต์บนแพลตฟอร์มไม่ละเมิดสิทธิในทรัพย์สินทางปัญญาหรือสิทธิอื่นใดของบุคคลที่สาม
              และผู้ใช้บริการมีสิทธิ์อย่างเต็มที่ในการให้สิทธิ์ตามที่ระบุไว้ในข้อ
              7.2.2
            </Typography>
          </Box>
          ...
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              8.1.1 แพลตฟอร์มนี้มีให้บริการในลักษณะ "ตามที่เป็น" และ "ตามที่มี"
              โดยไม่มีการรับประกันใดๆ ทั้งสิ้น ไม่ว่าจะโดยชัดแจ้งหรือโดยปริยาย
            </Typography>
            <Typography paragraph>
              8.1.2
              บริษัทไม่รับประกันว่าแพลตฟอร์มจะตรงตามความต้องการของผู้ใช้บริการ
              ทำงานได้อย่างต่อเนื่องหรือไม่มีข้อผิดพลาด มีความปลอดภัย
              หรือว่าข้อบกพร่องใดๆ จะได้รับการแก้ไข
            </Typography>
            <Typography paragraph>
              8.1.3 บริษัทไม่รับประกันหรือรับรองความถูกต้อง ความน่าเชื่อถือ
              หรือความปลอดภัยของข้อมูลหรือเนื้อหาที่ผู้ใช้บริการรายอื่นให้บนแพลตฟอร์ม
            </Typography>
            <Typography paragraph>
              8.1.4
              ผู้ใช้บริการยอมรับความเสี่ยงทั้งหมดที่เกี่ยวข้องกับการใช้แพลตฟอร์มและการมีปฏิสัมพันธ์กับผู้ใช้บริการรายอื่น
              รวมถึงแต่ไม่จำกัดเพียงความเสี่ยงในการพบเจอกับบุคคลที่มีเจตนาร้ายหรือไม่ซื่อสัตย์
              หรือการได้รับข้อมูลที่ไม่ถูกต้องหรือทำให้เข้าใจผิด
            </Typography>
          </Box>
          <Typography
            variant="h6"
          ...
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              8.2.1 ภายใต้ขอบเขตสูงสุดที่กฎหมายอนุญาต
              บริษัทจะไม่รับผิดต่อความเสียหายทางตรง ทางอ้อม บังเอิญ พิเศษ
              เป็นผลสืบเนื่อง หรือเป็นการลงโทษ
              ซึ่งเกิดจากหรือเกี่ยวข้องกับการใช้หรือไม่สามารถใช้แพลตฟอร์ม
            </Typography>
            <Typography paragraph>
              8.2.2 บริษัทจะไม่รับผิดชอบต่อความเสียหายใดๆ
              ที่เกิดจากการมีปฏิสัมพันธ์หรือการติดต่อกับผู้ใช้บริการรายอื่น
              ไม่ว่าจะเป็นภายในหรือภายนอกแพลตฟอร์ม
            </Typography>
            <Typography paragraph>
              8.2.3
              บริษัทจะไม่รับผิดชอบต่อการสูญหายหรือเสียหายของข้อมูลหรือเนื้อหาผู้ใช้
              ไม่ว่าจะเกิดจากสาเหตุใดก็ตาม
            </Typography>
            <Typography paragraph>
              8.2.4 ในกรณีที่มีความรับผิดเกิดขึ้น
              ความรับผิดโดยรวมของบริษัทต่อผู้ใช้บริการจะจำกัดเพียงจำนวนเงินที่ผู้ใช้บริการจ่ายให้แก่บริษัทเพื่อใช้บริการ
              (ถ้ามี) หรือ 1,000 บาท แล้วแต่จำนวนใดจะสูงกว่า
            </Typography>
          </Box>
          <Typography
            variant="h6"
            ...
            sx={{ fontWeight: "bold", mt: 2 }}
          >
            8.3 การชดใช้ค่าเสียหาย
          </Typography>
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              ผู้ใช้บริการตกลงที่จะชดใช้ ปกป้อง และทำให้บริษัท กรรมการ
              เจ้าหน้าที่ พนักงาน ตัวแทน
              และผู้ให้บริการของบริษัทไม่ได้รับความเสียหายจากการเรียกร้อง
              ความรับผิด ค่าเสียหาย ความสูญเสีย และค่าใช้จ่ายใดๆ
              (รวมถึงค่าทนายความและค่าธรรมเนียมศาลตามสมควร)
              ที่เกิดจากหรือเกี่ยวข้องกับ:
            </Typography>
            <Box sx={{ ml: 4 }}>
              <Typography paragraph>
                (ก) การใช้หรือการเข้าถึงแพลตฟอร์มของผู้ใช้บริการ
                <br />
                (ข) การละเมิดข้อตกลงนี้หรือกฎหมายที่เกี่ยวข้องของผู้ใช้บริการ
                <br />
                (ค) เนื้อหาผู้ใช้หรือการกระทำของผู้ใช้บริการบนแพลตฟอร์ม
                <br />
                (ง) ข้อพิพาทระหว่างผู้ใช้บริการกับผู้ใช้บริการรายอื่น
              </Typography>
            </Box>
          </Box>
          ...
          <Typography
            ...
            sx={{ fontWeight: "bold", mt: 2 }}
          >
            9.1 การเปลี่ยนแปลงบริการ
          </Typography>
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              9.1.1 บริษัทขอสงวนสิทธิ์ในการปรับเปลี่ยน ระงับ
              หรือยกเลิกแพลตฟอร์มหรือส่วนใดส่วนหนึ่งของแพลตฟอร์มได้ตลอดเวลา
              โดยอาจแจ้งหรือไม่แจ้งให้ทราบล่วงหน้า และไม่มีความรับผิดใดๆ
              ต่อผู้ใช้บริการหรือบุคคลที่สาม
            </Typography>
            <Typography paragraph>
              9.1.2 บริษัทอาจปรับปรุง เพิ่มเติม
              หรือลดฟีเจอร์ของแพลตฟอร์มได้ตามดุลยพินิจของบริษัทแต่เพียงผู้เดียว
            </Typography>
          </Box>
          <Typography
            variant="h6"
            ...
            sx={{ fontWeight: "bold", mt: 2 }}
          >
            9.2 การเปลี่ยนแปลงข้อตกลง
          </Typography>
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              9.2.1
              บริษัทขอสงวนสิทธิ์ในการแก้ไขหรือเปลี่ยนแปลงข้อตกลงนี้ได้ตลอดเวลา
              โดยจะแจ้งให้ผู้ใช้บริการทราบถึงการเปลี่ยนแปลงที่มีนัยสำคัญผ่านทางอีเมลหรือการแจ้งเตือนบนแพลตฟอร์ม
            </Typography>
            <Typography paragraph>
              9.2.2
              การใช้งานแพลตฟอร์มต่อไปหลังจากที่มีการแจ้งเกี่ยวกับการเปลี่ยนแปลงข้อตกลงถือเป็นการยอมรับข้อตกลงที่แก้ไขแล้ว
            </Typography>
            <Typography paragraph>
              9.2.3 หากผู้ใช้บริการไม่เห็นด้วยกับข้อตกลงที่แก้ไขแล้ว
              ผู้ใช้บริการควรหยุดใช้แพลตฟอร์มทันทีและลบบัญชีของตน
            </Typography>
          </Box>
          ...
          <Typography paragraph>
            ...
            และจะตีความและบังคับใช้ตามกฎหมายดังกล่าว
          ...
          <Typography
            ...
            sx={{ fontWeight: "bold", mt: 2 }}
          >
            10.2 การระงับข้อพิพาท
          </Typography>
          <Box sx={{ ml: 2 }}>
            <Typography paragraph>
              10.2.1 ในกรณีที่เกิดข้อพิพาทใดๆ
              ที่เกี่ยวข้องกับข้อตกลงนี้หรือการใช้แพลตฟอร์ม
              ผู้ใช้บริการและบริษัทตกลงที่จะพยายามแก้ไขข้อพิพาทดังกล่าวโดยการเจรจาอย่างฉันมิตรก่อน
            </Typography>
            <Typography paragraph>
              10.2.2 หากไม่สามารถแก้ไขข้อพิพาทได้โดยการเจรจาภายในระยะเวลา 30
              วันนับจากวันที่มีการแจ้งข้อพิพาทเป็นลายลักษณ์อักษร
              คู่กรณีทั้งสองฝ่ายตกลงที่จะนำข้อพิพาทดังกล่าวขึ้นสู่เขตอำนาจศาลที่มีอำนาจในประเทศไทย
            </Typography>
          </Box>
